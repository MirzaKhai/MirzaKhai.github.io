var nama = prompt("Name's Mirza, what's yours?");

alert("i wanna tell u something, " + nama);

alert("have u ever heard about quotes\n ''Two little mice fell into a bucket of cream. The first mouse quickly gave up and drowned. The second mouse, wouldn’t quit. He struggled so hard that eventually he churned that cream into butter and crawled out.''")

alert(nama + ", as of this moment, I am that second mouse.")

alert("I won't give up on you")

let playSound = () => new Audio("Sad Song.mpeg").play()
